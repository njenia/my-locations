      ...
      {!isEmpty(categoryLocations) ? (
        <React.Fragment>
          <Typography variant="body1">
            There are locations in category{" "}
            <strong>{categoryDetails.name}</strong>. To delete this category you
            need to delete these locations first:{" "}
          </Typography>
        ...
        <StyledForm>
          <FieldContainer>
            <Typography variant="body1">
              ...
              <strong>{categoryDetails.name}</strong>?
            </Typography>
          </FieldContainer>
          <FormActionContainer>
